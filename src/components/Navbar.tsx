    ...
    <header className="sticky top-0 z-50 nav-blur border-b border-drev-border/50">
      <div className="max-w-[1200px] mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          <Link href="https://github.com/drevci/drev" className="text-drev-text-secondary hover:text-drev-text text-[13px] font-medium transition-colors flex items-center gap-1.5">
          ...
          {mobileOpen && (
            <div className="fixed top-14 left-0 w-full bg-drev-bg/95 backdrop-blur-xl border-b border-drev-border flex flex-col p-6 gap-5 shadow-2xl">
              ...
              <div className="flex flex-col gap-3 pt-6 border-t border-drev-border">
                ...
                <Link href="https://github.com/drevci/drev" className="border border-drev-border text-center py-3 rounded-md font-medium text-drev-text-secondary hover:text-drev-text hover:border-drev-border-light transition-colors">GitHub</Link>
              </div>
            </div>
          )}
        </div>
